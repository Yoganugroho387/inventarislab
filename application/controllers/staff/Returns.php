...
class Returns extends CI_Controller {
    ...
    public function index() {
        ...
        $this->db->where('b.created_by', $userId);
    ...
    public function create($id) {
        ...
        if (!$borrowing || $borrowing['created_by'] != $userId || ($borrowing['status'] !== 'dipinjam' && $borrowing['status'] !== 'terlambat')) {
            $this->session->set_flashdata('error', 'Transaksi peminjaman tidak aktif atau tidak ditemukan.');
            redirect('staff/returns');
        }
    ...
    public function store($id) {
        ...
        if (empty($items_input)) {
            ...
            redirect('staff/returns/create/' . $id);
        }
    ...
    public function find_by_item_code() {
        ...
        // Query active borrowings created by this staff that contain this item
